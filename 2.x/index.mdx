...
related: ["/index", "/features", "/changelog"]
---
...
- **MCP Server** — Connect AI tools like Claude and Cursor to query monitoring data
- **Prometheus integration** — Expose speedtest metrics for external scraping
...
<CardGroup cols={2}>
  ...
  <Card title="Installation" icon="download" href="/using-docker-compose">
    Deploy Zepeed with Docker Compose
  </Card>

  <Card title="Providers and schedule" icon="rocket" href="/Providers-and-schedule">
    Configure your first speedtest in minutes
  </Card>

  <Card title="AI & MCP" icon="robot" href="/integrations/mcp">
    Connect AI tools to your monitoring
  </Card>
...
- **Need to configure providers?** See [providers and schedule](/Providers-and-schedule)
- **Building an integration?** Check out the [API reference](/api-reference)
- **Contributing?** Read the [contribution guidelines](/contribute)
