...
- `list-workflow-rules`: List speedtest workflow rules with pagination and an optional `is_active` filter.
- `create-workflow-rule`: Create a speedtest workflow rule with its conditions and actions.
- `update-workflow-rule`: Update a speedtest workflow rule by id.
- `delete-workflow-rule`: Delete a speedtest workflow rule by id.
- `toggle-workflow-rule`: Toggle the active state of a speedtest workflow rule.
