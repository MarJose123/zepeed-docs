...
description: "How to upgrade an existing Zepeed 1.x instance to 2.x — automatic table renames, the Ping Alert Rules → Workflow Rules merge, token abilities, breaking changes, rollback, and verification."
---
